...
\begin{frame}
	\begin{block}{Conjecture 1}
		The operator $\mathscr{B}^{-1}\mathscr{A}$ has mesh-independent eigenvalue clustering
	\end{block}
	\begin{block}{Conjecture 2}
		The condition number $\kappa$ of $\mathscr{B}^{-1}\mathscr{A}$ depends on $\Delta t$, $\alpha$, $\beta$, and $\gamma$
	\end{block}
