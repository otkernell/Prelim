...
%The Riesz map gets rid of mesh dependence but not parameter dependence??. [mard/win] Want to adjust B so it is still easy to invert but the bounds on B^-1A are as independent of eps as we can make them. 
