...
By discretizing \eqref{semidiscrete} with Crank Nicolson and partitioning the time interval $[0,T]$ into timesteps $0 \equiv t_0 < t_1 < t_2 < ... < t_N$, where $t_i = i\Delta t$,%this technically isn't right, since the delta t's are all different sizes. Should I specify this, or is it commonplace enough that it's understood?[]
